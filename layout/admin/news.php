...
<div class="abc-main" style="margin-left:300px;margin-top:43px;">
	...
	<header class="abc-container" style="padding-top:22px">
		<h5><b><i class="fa fa-newspaper-o"></i> Notícias</b></h5>
	</header>
        ...
        <ul class="abc-ul abc-card-8 abc-white">
			...
			<? foreach($news as $entry){?>
					<li class="abc-padding-16" data-id="<?=$entry['id']?>">
                        ...
                        <a href="/admin/news/edit/<?=$entry['id']?>" style="text-decoration: none;">
  ...
  <!-- End page content -->
    ...
    <script>
        ...
        function openModal(evt){
            newsId = evt.target.parentElement.getAttribute("data-id");
        ...
        function deleteMember(){
            post('/admin/news/delete',{'newsId':newsId});
        }
    </script>
<? include "footer.php" ?>