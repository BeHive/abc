...
<div class="abc-main" style="margin-left:300px;margin-top:43px;">
	...
	<header class="abc-container" style="padding-top:22px">
		<h5><b><i class="fa fa-university"></i> Sociedade</b></h5>
	</header>
        ...
        <h5>Lista</h5>
			<ul class="abc-ul abc-card-4 abc-white">
				...
				<? foreach($sociedades as $sociedade){ ?>
						<li class="abc-padding-16" data-id="<?=$sociedade['id']?>">
							<span onclick="openModal(event)" class="abc-closebtn abc-padding abc-margin-right abc-medium">x</span>
							<a href="/admin/sociedade/edit/<?=$sociedade['id']?>" style="text-decoration: none;">
								<span class="abc-xlarge"><?=utf8_decode($sociedade['titulo'])?></span><br>
							</a>
						</li>
                <?}?>
